...
plugins {
    id("com.android.application") version libs.versions.gradleAndroidPlugin apply false
    id("com.android.library") version libs.versions.gradleAndroidPlugin apply false
